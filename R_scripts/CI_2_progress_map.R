...
# Read in the data
mortality_trees <- read.csv("raw_data/Field_Maps/NZCBI_trees_mortality_2026_0.csv")
mortality_stems <- read.csv("raw_data/Field_Maps/NZCBI_stems_mortality_2026_1.csv")
