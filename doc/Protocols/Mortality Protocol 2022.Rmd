...
*If the status is “DC” & previously “DS”*: Record status and continue. 
...
**1** = small canker/ deformity area, smaller in area than a square of DBH **(SC)** DBH in shape.
**2**= big canker/ deformity, greater in area than a square of DBH **(SC)** DBH in shape.
