...
tree_species_summary$overall[which((tree_species_summary$IUCN.status == "Least concern" | is.na(tree_species_summary$IUCN.status)) & (tree_species_summary$mortality_status == "H" | tree_species_summary$AU_status == "H") & tree_species_summary$n.living < 50) ] <- "M"

tree_species_summary$overall[which((tree_species_summary$IUCN.status == "Least concern" | is.na(tree_species_summary$IUCN.status)) & (tree_species_summary$mortality_status == "M" & tree_species_summary$AU_status != "H") | (tree_species_summary$AU_status == "M" & tree_species_summary$mortality_status != "H")  & tree_species_summary$n.living >= 50) ] <- "M"

tree_species_summary$overall[which((tree_species_summary$IUCN.status == "Least concern" | is.na(tree_species_summary$IUCN.status)) & (tree_species_summary$mortality_status == "M" & tree_species_summary$AU_status != "H") | (tree_species_summary$AU_status == "M" & tree_species_summary$mortality_status != "H")  & tree_species_summary$n.living < 50) ] <- "L"
...
tree_species_summary$overall[which((tree_species_summary$IUCN.status == "Least concern" | is.na(tree_species_summary$IUCN.status)) & tree_species_summary$mortality_status == "L" & tree_species_summary$AU_status == "L") ] <- "L"
