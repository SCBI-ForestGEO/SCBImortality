...
mortality_rate_by_species_2021 <- mortality_by_species[ which(mortality_by_species$variable=='mortality_rates' & mortality_by_species$survey_year == 2021),]
names(mortality_rate_by_species_2021)[names(mortality_rate_by_species_2021) == 'sp'] <- 'Tree.species.code'
mortality_rate_by_species_2021$n_latest <- mortality_rate_by_species_2021$N0 - mortality_rate_by_species_2021$n_died
...
tree_species_summary <- merge(tree_species_summary, mortality_rate_by_species_2021, by = "Tree.species.code", all.x = TRUE)  # merge tables
tree_species_summary[,3] <- tree_species_summary$n_latest # put n_latest in desired column
tree_species_summary = subset(tree_species_summary, select = -c(9:17) )  # remove columns from mortality_rate_by_species_2021
