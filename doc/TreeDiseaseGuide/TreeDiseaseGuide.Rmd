...
knitr::kable(tree_species_summary,
  ...
  add_header_above(c( " "= 5, "concern level"=3 )) %>%
...
TDmrowsum1 <- rowSums(TDmatrix[,3:(ceiling((ncol(TDmatrix)-2)/2))])
TDmrowsum2 <- rowSums(TDmatrix[,(ceiling((ncol(TDmatrix)-2)/2)+1):ncol(TDmatrix)])
TDmatrix1 <- TDmatrix[TDmrowsum1>0,1:(ceiling((ncol(TDmatrix)-2)/2))]
TDmatrix2 <- TDmatrix[TDmrowsum2>0,c(1:2,(ceiling((ncol(TDmatrix)-2)/2)+1):ncol(TDmatrix))]

TDconcern_index=paste0("",tree_species_summary$overall)
TDconcern_index1 <- TDconcern_index[1:(ceiling((ncol(TDmatrix)-2)/2)-1)]
TDconcern_index2 <- TDconcern_index[c(1,(ceiling((ncol(TDmatrix)-2)/2)-1):(ncol(TDmatrix)-2))]
